          ...
          <GridItem xs={12} sm={12} md={12}>
            <GridContainer className={classes.textCenter} justify="center">
              ...
              <GridItem xs={12} sm={12} md={8}>
                ...
                <GridContainer className={classes.textCenter} justify="center">
                  <GridItem xs={6} sm={6} md={3}>
                    <img src="amazonws.png" alt="amazonws" style={{ height: "70px", width: "150px" }}></img>
                  </GridItem>

                  <GridItem xs={6} sm={6} md={3}>
                    <img src="rubyonrails.png" alt="rubyonrails" style={{ height: "70px", width: "150px" }}></img>
                  </GridItem>
                  <GridItem xs={6} sm={6} md={3}>
                    <img src="graphQL.png" alt="graphQL" style={{ height: "100px", width: "150px" }}></img>
                  </GridItem>
                  <GridItem xs={6} sm={6} md={3}>
                    <img src="android.jpg" alt="android" style={{ height: "90px", width: "150px" }}></img>
                  </GridItem>
                </GridContainer>
              </GridItem>
              ...
              <GridItem xs={12} sm={12} md={8}><br />
                <GridContainer className={classes.textCenter} justify="center">
                  <GridItem xs={6} sm={6} md={4}>
                    <img src="adobeLogo.png" alt="adobe" style={{ height: "60px", width: "200px" }}></img>
                  </GridItem>
                  <GridItem xs={6} sm={6} md={4}>
                    <img src="AdobeExperienceMgr.png" alt="aemm" style={{ height: "110px", width: "200px", marginTop: "-15px" }}></img>
                  </GridItem>
                  <GridItem xs={6} sm={6} md={4}>
                    <img src="dpsc.jpg" alt="dpsc" style={{ height: "80px", width: "80px" }}></img>
                  </GridItem>
                </GridContainer><br />
                <GridContainer className={classes.textCenter} justify="center">
                </GridContainer>
